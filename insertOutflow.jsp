...
<html>
<head>
	<link rel="stylesheet" type="text/css" href="style/insertOutflow.css"/>
...
<body>
	...
	<div id="insertOutflowForm">
		<p class="formTitle">
			Insert Outflow
		</p>
		<form action="controller/val_insertOutflow.jsp" method="post">
			<div class="formContainer">
				...
				<div class="rowContainer">
					<button id="btnInsertOutflowSubmit" name="submit">
						Submit
					</button>
					<button id="btnInsertOutflowCancel" name="cancel" onclick="window.location.href='/WebProg/Project_Kelas/index.jsp'">
						Cancel
					</button>
				</div>
			</div>
...
<script>
	...
	if(code == 'invalidTruckID'){
		...
		alert("Insert New Outflow Success");
	}
</script>
</html>